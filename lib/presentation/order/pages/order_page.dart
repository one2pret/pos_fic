...
import 'package:pos_fic/presentation/order/widgets/payment_cash_dialog.dart';
import 'package:pos_fic/presentation/order/widgets/payment_qris_dialog.dart';
import 'package:pos_fic/presentation/order/widgets/process_button.dart';
            ...
            BlocBuilder<CheckoutBloc, CheckoutState>(
              builder: (context, state) {
                return state.maybeWhen(
                  ...
                  success: (data, totalQuantity, totalPrice) {
                ...
                if (indexValue.value == 0) {
                  ...
                  showDialog(
                    ...
                    builder: (context) => PaymentCashDialog(
                      price: totalPrice, //calculateTotalPrice(orders),
                    ),
                  );
