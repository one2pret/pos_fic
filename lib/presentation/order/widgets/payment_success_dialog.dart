...
import 'package:pos_fic/core/extensions/date_time_ext.dart';
import 'package:pos_fic/core/extensions/int_ext.dart';
import 'package:pos_fic/data/dataoutputs/cwb_print.dart';
      ...
      content: BlocBuilder<OrderBloc, OrderState>(
        builder: (context, state) {
          return state.maybeWhen(
              ...
              success: (data, qty, totalPembelian, paymentType, nominal,
                  idKasir, namaKasir) {
                // print(nominal);
                ...
                return Column(
                  ...
                  children: [
                    ...
                    _LabelValue(
                      ...
                      value: totalPembelian.currencyFormatRp,
                    ),
                    const Divider(height: 36.0),
                    _LabelValue(
                      label: 'NOMINAL BAYAR',
